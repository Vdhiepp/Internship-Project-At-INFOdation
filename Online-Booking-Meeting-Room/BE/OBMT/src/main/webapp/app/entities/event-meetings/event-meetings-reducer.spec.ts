...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTMEETINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVENTMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTMEETINGS actions', async () => {
      const expectedActions = [
        {
