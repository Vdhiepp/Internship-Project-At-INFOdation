...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVENTUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTUSERS actions', async () => {
      const expectedActions = [
        {
