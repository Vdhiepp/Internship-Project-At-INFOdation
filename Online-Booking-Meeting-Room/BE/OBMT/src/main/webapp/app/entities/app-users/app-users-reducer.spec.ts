...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './app-users.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPUSERS actions', async () => {
      const expectedActions = [
        {
