...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGROOMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEETINGROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEETINGROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEETINGROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEETINGROOMS actions', async () => {
      const expectedActions = [
        {
