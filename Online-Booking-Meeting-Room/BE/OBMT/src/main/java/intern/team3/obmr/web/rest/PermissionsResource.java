...
import intern.team3.obmr.repository.PermissionsRepository;
import intern.team3.obmr.service.PermissionsService;
...
/**
 * REST controller for managing {@link intern.team3.obmr.domain.Permissions}.
 */
@RestController
@RequestMapping("/api")
public class PermissionsResource {
    ...
    public PermissionsResource(PermissionsService permissionsService, PermissionsRepository permissionsRepository) {
    ...
    public ResponseEntity<PermissionsDTO> updatePermissions(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, permissionsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PermissionsDTO> partialUpdatePermissions(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, permissionsDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<PermissionsDTO>> getAllPermissions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Permissions");
        Page<PermissionsDTO> page = permissionsService.findAll(pageable);
